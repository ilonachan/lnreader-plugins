                    ...
                    case 1:
                        ...
                        if ((_b = (_a = this.options) === null || _a === void 0 ? void 0 : _a.customJs) === null || _b === void 0 ? void 0 : _b.chapterTransform) {
                            try {
                                (_c = $('article > style')
                                    .text()
                                    .match(/\\.\\w+(?=\\s*[,{])/g)) === null || _c === void 0 ? void 0 : _c.forEach(function (tag) { return $("p".concat(tag)).remove(); });
