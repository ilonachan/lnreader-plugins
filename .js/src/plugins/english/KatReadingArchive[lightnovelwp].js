            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        if ((_b = (_a = this.options) === null || _a === void 0 ? void 0 : _a.customJs) === null || _b === void 0 ? void 0 : _b.chapterTransform) {
                            try {
                                $('div.epcontent > span:first-of-type').remove();
                                $('.ckb-wrap').remove();
                            }
                            catch (error) {
                        ...
                        return [2 /*return*/, (_c = content.html()) !== null && _c !== void 0 ? _c : ''];
                }
            });
        });
    };
...
var plugin = new LightNovelWPPlugin({ "id": "katreadingarchive", "sourceSite": "https://katreadingarchive.me", "sourceName": "Kat Reading Archive", "options": { "lang": "English", "versionIncrements": 1, "reverseChapters": true, "hasLocked": true, "customJs": { "chapterTransform": "$('div.epcontent > span:first-of-type').remove(); $('.ckb-wrap').remove();", "runtime": "multisrc/lightnovelwp/katreadingarchive/customJs.js" }, "customCss": "multisrc/lightnovelwp/katreadingarchive/customCss.css" } });
