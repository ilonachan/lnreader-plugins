...
var plugin = new LightNovelWPPlugin({ "id": "katreadingarchive", "sourceSite": "https://katreadingcafe.com", "sourceName": "Kat Reading Cafe", "options": { "lang": "English", "versionIncrements": 2, "reverseChapters": true, "hasLocked": true, "customJs": { "chapterTransform": "$('div.epcontent > span:first-of-type').remove(); $('.ckb-wrap').remove();", "runtime": "multisrc/lightnovelwp/katreadingarchive/customJs.js" }, "customCss": "multisrc/lightnovelwp/katreadingarchive/customCss.css" } });
