...
var FictioneerPlugin = /** @class */ (function () {
    ...
    FictioneerPlugin.prototype.parseChapter = function (chapterPath) {
        return __awaiter(this, void 0, void 0, function () {
            var req, body, loadedCheerio, scriptContent, gibMatch, gibArray;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, (((_a = loadedCheerio('section#chapter-content > div')
...
var plugin = new FictioneerPlugin({ "id": "lilyonthevalley", "sourceSite": "https://lilyonthevalley.com", "sourceName": "Lily on the Valley", "options": { "customJs": { "chapterTransform": "custom/lillyonthevalley/chapterTransform.js" }, "versionIncrements": 1, "browsePage": "stories" } });
