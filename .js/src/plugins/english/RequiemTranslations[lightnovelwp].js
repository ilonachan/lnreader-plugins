...
var LightNovelWPPlugin = /** @class */ (function () {
    function LightNovelWPPlugin(metadata) {
        ...
        this.customJS = (_c = this.options.customJs) === null || _c === void 0 ? void 0 : _c.runtime;
        this.customCSS = this.options.customCss;
        if ((_d = this.options) === null || _d === void 0 ? void 0 : _d.hasLocked) {
            this.pluginSettings = {
                hideLocked: {
                    value: '',
    ...
    LightNovelWPPlugin.prototype.safeFetch = function (url, search) {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.safeFetch(url, false)];
                    case 1:
                        html = _f.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        baseURL = this.site;
                        return [4 /*yield*/, this.safeFetch(baseURL + novelPath, false)];
                    case 1:
                        html = _e.sent();
                        novel = {
                            path: novelPath,
                        ...
                        chapters = [];
                        tempChapter = {};
                        hideLocked = !!((_a = storage_1.storage.get('hideLocked')) !== null && _a !== void 0 ? _a : (_b = this.pluginSettings) === null || _b === void 0 ? void 0 : _b['hideLocked'].value);
                        ...
                        parser.end();
                        if (chapters.length) {
                            if ((_c = this.options) === null || _c === void 0 ? void 0 : _c.reverseChapters)
                                chapters.reverse();
                            novel.chapters = chapters;
                        }
                        novel.summary = (_d = novel.summary) === null || _d === void 0 ? void 0 : _d.trim();
    ...
    LightNovelWPPlugin.prototype.parseChapter = function (chapterPath) {
        return __awaiter(this, void 0, void 0, function () {
            var data, $, url_1, offsets_1, idx_1, _a, _1, offsetLower_1, offsetCap_1, asciiA_1, asciiz_1, content;
            var _b, _c, _d, _e;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0: return [4 /*yield*/, this.safeFetch(this.site + chapterPath, false)];
                    case 1:
                        data = _f.sent();
                        $ = (0, cheerio_1.load)(data);
                        if ((_c = (_b = this.options) === null || _b === void 0 ? void 0 : _b.customJs) === null || _c === void 0 ? void 0 : _c.chapterTransform) {
                            try {
                                $('div.entry-content script').remove();
                                url_1 = this.site + chapterPath.slice(0, -1);
                                offsets_1 = [
                                    [0, 12368, 12462],
                                    [1, 6960, 7054],
                                    [2, 4176, 4270],
                                ];
                                idx_1 = (url_1.length * url_1.charCodeAt(url_1.length - 1) * 2) % 3;
                                _a = (_d = offsets_1[idx_1]) !== null && _d !== void 0 ? _d : offsets_1[0], _1 = _a[0], offsetLower_1 = _a[1], offsetCap_1 = _a[2];
                        ...
                        content = $('div.epcontent');
                        // content.find('h1:first-child').remove();
                        // content.find('> :not(p)').remove();
                        return [2 /*return*/, (_e = content.html()) !== null && _e !== void 0 ? _e : ''];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.safeFetch(url, true)];
                    case 1:
                        html = _a.sent();
                        return [2 /*return*/, this.parseNovels(html)];
                }
