...
var LightNovelWPPlugin = /** @class */ (function () {
    ...
    LightNovelWPPlugin.prototype.parseChapter = function (chapterPath) {
        return __awaiter(this, void 0, void 0, function () {
            var data, $, url, offsets, idx, _a, _, offsetLower_1, offsetCap_1, asciiA_1, asciiz_1, content;
            var _b, _c, _d, _e;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 1:
                        ...
                        if ((_c = (_b = this.options) === null || _b === void 0 ? void 0 : _b.customJs) === null || _c === void 0 ? void 0 : _c.chapterTransform) {
                            try {
                                ...
                                _a = (_d = offsets[idx]) !== null && _d !== void 0 ? _d : offsets[0], _ = _a[0], offsetLower_1 = _a[1], offsetCap_1 = _a[2];
