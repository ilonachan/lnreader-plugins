...
var NovelUpdates = /** @class */ (function () {
    ...
    NovelUpdates.prototype.getChapterBody = function (loadedCheerio, domain, chapterPath) {
        return __awaiter(this, void 0, void 0, function () {
            var bloatElements, chapterTitle, chapterContent, chapterText, unwanted, targetDomain, _a, apiUrl, response, json, error_1, titleElement, extractBrightNovelsContent, fallbackContent, fallbackCheerio, parts, novelSlug, chapterSlug, url_1, response, json, data, chapterNumber, title, content, titleElement, error_2, url_2, json, nodes, data, contentKey, notesKey, footnotesKey, key, mapping, content, notes, footnotes, error_3, chapterString_helscans_1, url_3, response, body, matchResult, urlPath, pathSegments, pathDepth, loadedCheerioSlicedBread, chapterPath_1, response, body, titleElement, chapterCheerio_1, parts, url_4, json, titleElement, displayedDiv, loadedCheerioSnow_1, titleElement, chapterId, url_5, ageVerification, url_6, response, body, titleElement, url_7, response, body, scriptContent, jsonString_wetried, chapterId, url_8, json, titleElement;
            var _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 9:
                        ...
                        novelSlug = parts[4];
                        chapterSlug = parts[6];
                        url_1 = "".concat(parts[0], "//").concat(parts[2], "/api/public/chapter-by-slug/").concat(novelSlug, "/").concat(chapterSlug);
                    ...
                    case 14:
                        ...
                        _d.label = 15;
                    case 15:
                        url_2 = "".concat(chapterPath, "/__data.json?x-sveltekit-invalidated=001");
                        _d.label = 16;
                    case 16:
                        _d.trys.push([16, 18, , 19]);
                        return [4 /*yield*/, (0, fetch_1.fetchApi)(url_2).then(function (r) { return r.json(); })];
                    case 17:
                        json = _d.sent();
                        nodes = json.nodes;
                        data = nodes
                    ...
                    case 22:
                        ...
                        _d.label = 23;
                    case 23:
                        url_3 = loadedCheerio('article > p > a').first().attr('href');
                        if (!url_3) return [3 /*break*/, 26];
                        return [4 /*yield*/, (0, fetch_1.fetchApi)(url_3)];
                    case 24:
                        response = _d.sent();
                        return [4 /*yield*/, response.text()];
                    case 25:
                    ...
                    case 37:
                        parts = chapterPath.split('/');
                        url_4 = "".concat(parts[0], "//api.").concat(parts[2], "/api/chapters/single?id=").concat(parts[3], "&num=").concat(parts[4]);
                        return [4 /*yield*/, (0, fetch_1.fetchApi)(url_4).then(function (r) { return r.json(); })];
                    case 38:
                        json = _d.sent();
                    ...
                    case 41:
                        ...
                        url_5 = "".concat(chapterPath.split('chapter')[0], "txt/").concat(chapterId, ".txt");
                        return [4 /*yield*/, (0, fetch_1.fetchApi)(url_5)
                    ...
                    case 45:
                        ...
                        _d.label = 46;
                    case 46:
                        url_6 = loadedCheerio('.entry-content a').attr('href');
                        if (!url_6) return [3 /*break*/, 49];
                        return [4 /*yield*/, (0, fetch_1.fetchApi)(url_6)];
                    case 47:
                        response = _d.sent();
                        return [4 /*yield*/, response.text()];
                    case 48:
                    ...
                    case 51:
                        ...
                        _d.label = 52;
                    case 52:
                        url_7 = loadedCheerio('.entry-content a').attr('href');
                        if (!url_7) return [3 /*break*/, 55];
                        return [4 /*yield*/, (0, fetch_1.fetchApi)(chapterPath + url_7)];
                    case 53:
                        response = _d.sent();
                        return [4 /*yield*/, response.text()];
                    case 54:
                    ...
                    case 60:
                        chapterId = chapterPath.split('/').pop();
                        url_8 = "https://pxp-main-531j.onrender.com/api/v1/book_chapters/".concat(chapterId, "/content");
                        return [4 /*yield*/, (0, fetch_1.fetchApi)(url_8).then(function (r) { return r.json(); })];
                    case 61:
                        json = _d.sent();
